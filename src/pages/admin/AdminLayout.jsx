...
const NAV = [
  ...
  { path: '/admin/previous-conferences', label: 'Previous Conferences', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 4h18v16H3z"/><path d="M7 8h10M7 12h10M7 16h6"/>
    </svg>
  )},
  { path: '/admin/reviewers', label: 'Reviewers', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="9" cy="7" r="3"/><path d="M3 20c0-3.5 2.7-6 6-6s6 2.5 6 6"/><path d="M16 11a3 3 0 1 0-1.7-5.5"/></svg>
  )},
  ...
  { path: '/admin/callforpapers', label: 'Call for Papers', icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
