    ...
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
        ...
        <p className="text-sm mt-1" style={{ color: '#7A9AA6' }}>
          ICONICS'26 — December 23-24, 2026 · NED University, Karachi
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.4 }}
          ...
          <div className="space-y-1">
            ...
            <QuickAction to="/admin/callforpapers" label="Call for Papers Assets" delay={0.55}
              icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeLinecap="round" strokeLinejoin="round"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg>} />
          </div>
        </motion.div>
      </div>
    </div>
