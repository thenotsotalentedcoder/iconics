      ...
      <div className="min-h-screen pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 bg-bg-primary">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          ...
          <section className="mb-3 sm:mb-4 sm:mb-6 sm:mb-8 sm:mb-12 sm:mb-16">
            <h3 className="text-xl sm:text-2xl font-bold font-heading text-text-primary mb-3 sm:mb-4 sm:mb-6 sm:mb-8">Organizing Committee</h3>
          ...
          <section>
            <h3 className="text-xl sm:text-2xl font-bold font-heading text-text-primary mb-3 sm:mb-4 sm:mb-6 sm:mb-8">Technical Program Committee</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {technicalCommittee.map((member, index) => (
                ...
                >
                  <h4 className="text-text-primary font-semibold mb-1">{member.name}</h4>
