    ...
    <section className="py-12 sm:py-16 md:py-24 bg-bg-secondary">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold font-heading text-text-primary mb-4 sm:mb-6">
              About ICONICS
            </h2>
            <div className="space-y-3 sm:space-y-4 text-text-secondary text-sm sm:text-base">
              ...
              <p>
                With a focus on <strong className="text-accent">AI, Quantum Computing, and Cybersecurity</strong>, ICONICS'26 brings together leading experts, researchers, and practitioners from around the world.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 my-6 sm:my-8">
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-accent font-accent">500+</div>
                <div className="text-text-muted text-xs sm:text-sm">Attendees</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-accent font-accent">50+</div>
          ...
          >
            <div className="relative">
              <div className="aspect-video bg-bg-card border border-border-subtle rounded-lg overflow-hidden hover:border-accent/50 transition-all group shadow-card">
                <img
                  src={nedImage}
              ...
              {/* Floating badge */}
              <motion.div
                className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-accent text-white p-4 sm:p-6 rounded-lg shadow-glow"
                animate={{ y: [0, -10, 0] }}
