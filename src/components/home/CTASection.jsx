      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="relative bg-accent rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 px-8 py-16 lg:px-16 lg:py-24 text-center">
            <motion.span
              className="inline-block text-white/70 text-sm font-semibold tracking-wider uppercase mb-4"
            ...
            >
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white hover:bg-cream-50 text-accent font-semibold rounded-lg transition-all duration-300 hover:shadow-large"
              >
                Submit Paper
              ...
              <Link
                to="/registration"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white/40 hover:border-white text-white font-semibold rounded-lg transition-all duration-300 hover:bg-white/10"
              >
                Register Now
              </Link>
            </motion.div>
            ...
            {/* Stats Row */}
            <motion.div
              className="mt-16 pt-10 border-t border-white/20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto"
              initial={{ opacity: 0 }}
